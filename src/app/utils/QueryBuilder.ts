import { IQueryConfig, IQueryParams, PrismaCountArgs, PrismaFindArgs, PrismaModelDelegate, PrismaNumberFilter, PrismaStringFilter, PrismaWhereConditions } from "../interfaces/query.interface";
...
> {
    ...
    filter(): this {
        ...
        const excludeField = ['searchTerm', 'page', 'limit', 'sortBy', 'sortOrder', 'fileds', 'include'];
        ...
        Object.keys(filterParams).forEach((key) => {
            ...
            const isAllowField = !filterableFields || filterableFields.length === 0 || filterableFields.includes(key);
            ...
            if(key.includes(".")){
                ...
                if(parts.length === 2) {
                    ...
                    queryNestedRelation[nestedRelation] = this.parseFilterValue(value);
                    countNestedRelation[nestedRelation] = this.parseFilterValue(value);
